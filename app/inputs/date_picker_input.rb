class DatePickerInput < SimpleForm::Inputs::StringInput
  def input(wrapper_options)
    ...
    classes = ["input-group", "date", "datetimepicker"]
  ...
  def value
    v = object.send(attribute_name) if object.respond_to?(attribute_name) || object.kind_of?(Ransack::Search)
    v = v.to_date if v.kind_of?(String)
    v
  end
